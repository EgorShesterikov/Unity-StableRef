...
namespace Utility.StableRef
{
    public static class StableRefPropertyUtils
    {
        ...
        public static bool HasStableRefSelectorAttribute(SerializedProperty property)
        {
        ...
        private static bool TryResolvePath(SerializedProperty property, out PathResolution result)
        {
            ...
            result = new PathResolution
            {
                ...
                HasAttribute = field != null && field.GetCustomAttribute<StableRefSelectorAttribute>() != null
            };
