...
namespace SST.StableRef
{
    internal static class StableRefContextMenu
    {
        ...
        private static void AppendContextMenuItems(GenericMenu menu, SerializedProperty property)
        {
            ...
            {
                if (!StableRefPropertyUtils.HasStableRefSelectorAttribute(property)) return;
            ...
            if (property.isArray
                && (StableRefPropertyUtils.IsStableRefArray(property)
                    || (StableRefPropertyUtils.IsManagedReferenceArray(property)
                        && StableRefPropertyUtils.HasStableRefSelectorAttribute(property))))
            {
